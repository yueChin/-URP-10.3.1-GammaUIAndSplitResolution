Shader "Hidden/Universal Render Pipeline/Blit"
{
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal@10.3.1//Shaders/Utils/Fullscreen.hlsl"
            #include "Packages/com.unity.render-pipelines.universal@10.3.1/ShaderLibrary/Core.hlsl"
